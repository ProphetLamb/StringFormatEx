...
namespace StringFormatEx
{
    public static partial class StringBuilderExtensions
    {
        ...
        {
            return builder.Append(builder.Append(FormattingEx.Format(format, provider, options, GetArgumentSpan(1, arg0))));
        }
        ...
        public static StringBuilder AppendFormatEx(
            ...
            StringFormattingOptions options = StringFormattingOptions.None)
        {
            return builder.Append(FormattingEx.Format(format, provider, options, GetArgumentSpan(2, arg0, arg1)));
        }
        ...
        public static StringBuilder AppendFormatEx(
            ...
            StringFormattingOptions options = StringFormattingOptions.None)
        {
            return builder.Append(FormattingEx.Format(format, provider, options, GetArgumentSpan(3, arg0, arg1, arg2)));
        }
        ...
        public static StringBuilder AppendFormatEx(
            ...
            StringFormattingOptions options = StringFormattingOptions.None)
        {
            return builder.Append(FormattingEx.Format(format, provider, options, GetArgumentSpan(4, arg0, arg1, arg2, arg3)));
        }
            ...
            params FormattingArgument[] args)
        {
            ...
            return builder.Append(FormattingEx.Format(format, provider, options, args));
        }
